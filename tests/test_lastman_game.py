...
def mock_update():
    ...
    update.callback_query.message = AsyncMock() # Keep message as AsyncMock
...
# @pytest.mark.asyncio
# async def test_lastman_callback_handler_join_success(mock_update, mock_context, mocker): # Added mocker
...
@patch('yunks_game_2_0_1.handlers.lastman_game.notify_next_elimination', new_callable=AsyncMock)
async def test_perform_elimination(mock_notify_next_elimination, mock_end_game, mock_update, mock_context):
